        ...
        public static ObservableCollection<Schedule> CreateDefaultSchedules(string path)
        {
            ...
            var schedules = new ObservableCollection<Schedule>
            {
                new("В_ОВ_Гибкие воздуховоды",
                    new CopyStringOperation(SpfParameter.Name, defaultColumn),
                    new CopyLengthOperation(SpfParameter.Quantity, ProjectGlobalParameter.Reserve)),
                new("В_ОВ_Изоляция воздуховодов",
                    new CopyStringOperation(SpfParameter.Name, defaultColumn),
                    new CopyAreaOperation(SpfParameter.Quantity, ProjectGlobalParameter.Reserve)),
                new("В_ОВ_Круглые воздуховоды",
                    new CopyStringOperation(SpfParameter.Name, defaultColumn),
                    new CopyLengthOperation(SpfParameter.Quantity, ProjectGlobalParameter.Reserve),
                    new CopyStringOperation(SpfParameter.Note, 8)),
                ...
                new("В_ОВ_Гибкие трубы",
                    new CopyStringOperation(SpfParameter.Name, defaultColumn),
                    new CopyIntegerOperation(SpfParameter.Quantity, 1)),
                new("В_ОВ_Изоляция труб",
                    new CopyStringOperation(SpfParameter.Name, defaultColumn),
                    new CopyVolumeOperation(SpfParameter.Quantity, ProjectGlobalParameter.Reserve)),
                ...
                new("В_ТМ_Технико-экономические показатели",
                    new CopyMassOperation(SpfParameter.MassWithDimension, defaultColumn)),
